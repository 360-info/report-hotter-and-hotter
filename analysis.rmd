...
survey_remote_root <-
  "https://github.com/Cool-infrastructures/Covid19-Heat/raw/main/data/raw_data/"

# download the surveys (cc-by 4.0) from:
# https://github.com/Cool-infrastructures/Covid19-Heat
# extra info, like survey coding framework, available from:
# https://doi.org/10.7488/ds/2961

cameroon <- bind_rows(
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Cameroon%20Raw%20Data%20Wave%201.csv")),
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Cameroon%20Raw%20Data%20Wave%202.csv")))
indonesia <- bind_rows(
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Indonesia%20Raw%20Data%20Wave%201.csv")),
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Indonesia%20Raw%20Data%20Wave%202.csv")))
india <- bind_rows(
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20India%20Raw%20Data%20Wave%201.csv")),
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20India%20Raw%20Data%20Wave%202.csv")))
pakistan <- bind_rows(
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Pakistan%20Raw%20Data%20Wave%201.csv")),
  import_survey(paste0(survey_remote_root,
    "Cool%20Infrastructures%20Pakistan%20Raw%20Data%20Wave%202.csv")))
